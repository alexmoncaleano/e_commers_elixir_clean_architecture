defmodule ECommersCa.Application do
  alias ECommersCa.Infrastructure.EntryPoint.ApiRest
  alias ECommersCa.Config.{AppConfig, ConfigHolder}
  alias ECommersCa.Utils.CertificatesAdmin
